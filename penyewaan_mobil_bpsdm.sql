...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2025 at 05:29 AM
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','pegawai','sopir') NOT NULL,
  `created_at` datetime DEFAULT current_timestamp(),
...
--
-- Constraints for table `jadwal_mobil`
--
ALTER TABLE `jadwal_mobil`
  ADD CONSTRAINT `jadwal_mobil_ibfk_1` FOREIGN KEY (`mobil_id`) REFERENCES `mobil` (`id`),
  ADD CONSTRAINT `jadwal_mobil_ibfk_2` FOREIGN KEY (`pemesanan_id`) REFERENCES `pemesanan` (`id`);
...
ALTER TABLE `pemesanan`
  ...
  ADD CONSTRAINT `pemesanan_ibfk_2` FOREIGN KEY (`mobil_id`) REFERENCES `mobil` (`id`),
  ADD CONSTRAINT `pemesanan_ibfk_3` FOREIGN KEY (`sopir_id`) REFERENCES `users` (`id`);
COMMIT;
