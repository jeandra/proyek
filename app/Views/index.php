...
<head>
    ...
    <style>
        body {
            ...
            background-color: #f7fafc; /* Latar belakang fallback lebih halus */
        }
        .animated-gradient {
            background-size: 300%;
            background-image: linear-gradient(
                -45deg,
                #E0E7F0 0%, /* Lightest blue-gray */
                #F0F4F8 25%, /* Off-white */
                #E8EFF5 50%, /* Mid blue-gray */
                #F0F4F8 75%,
                #E0E7F0 100%
            );
        ...
        .dark .animated-gradient {
            background-image: linear-gradient(
                -45deg,
                #0A121A 0%, /* Sangat gelap, hampir hitam */
                #070E14 25%, /* Lebih gelap lagi */
                #101C28 50%, /* Biru gelap keunguan */
                #070E14 75%,
                #0A121A 100%
            );
        }
        ...
        .delay-5 { animation-delay: 0.5s; } /* Tambahan delay */

        /* Custom shadow for a more professional look */
        .shadow-custom-light {
            box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08), 0 4px 12px rgba(0, 0, 0, 0.04);
        }
        .dark .shadow-custom-dark {
            box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5), 0 4px 12px rgba(0, 0, 0, 0.25); /* Shadow lebih kuat di dark mode */
        }
        /* Glassmorphism effect */
        .glassmorphism {
            background-color: rgba(255, 255, 255, 0.15); /* Sedikit lebih opaque */
            backdrop-filter: blur(15px); /* Blur sedikit lebih kuat */
            -webkit-backdrop-filter: blur(15px);
            border: 1px solid rgba(255, 255, 255, 0.3); /* Border lebih jelas */
        }
        .dark .glassmorphism-dark {
            background-color: rgba(0, 0, 0, 0.35); /* Lebih solid di dark mode untuk kontras */
            backdrop-filter: blur(18px); /* Blur lebih kuat lagi */
            -webkit-backdrop-filter: blur(18px);
            border: 1px solid rgba(255, 255, 255, 0.12); /* Border sedikit lebih terlihat */
        }
        ...
        .hero-image-overlay::after {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(to top, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0) 50%, rgba(0,0,0,0.4) 100%); /* Vignette effect */
            border-radius: 1rem; /* match image border-radius */
            transition: all 0.5s ease;
        }
        .dark .hero-image-overlay::after {
             background: linear-gradient(to top, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.1) 50%, rgba(0,0,0,0.6) 100%);
        }
        .hero-image-overlay:hover::after {
            background: linear-gradient(to top, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0) 50%, rgba(0,0,0,0.2) 100%);
        }
        .dark .hero-image-overlay:hover::after {
            background: linear-gradient(to top, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0) 50%, rgba(0,0,0,0.4) 100%);
        }

        /* Button hover effect: subtle 3D push */
        .btn-3d-push:active {
        ...
        /* Feature card subtle transform on hover */
        .feature-card:hover {
            transform: translateY(-8px) scale(1.02); /* Lebih terasa "pop" */
            box-shadow: 0 15px 40px rgba(0, 0, 0, 0.12), 0 6px 20px rgba(0, 0, 0, 0.08);
        }
        .dark .feature-card:hover {
            box-shadow: 0 15px 40px rgba(0, 0, 0, 0.6), 0 6px 20px rgba(0, 0, 0, 0.35);
        }
    </style>
</head>
        ...
        <div class="relative container mx-auto px-6">
            <div class="flex justify-between items-center h-20">
                <a href="#" class="flex items-center space-x-2">
                    <svg class="h-9 w-9 text-blue-700 dark:text-blue-400 animate-fade-in-up delay-1" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14.59L6.41 12 5 13.41 11 19.41l8-8L17.59 10 11 16.59z"/></svg>
                    <span class="text-xl font-extrabold text-gray-900 dark:text-white animate-fade-in-up delay-2">BPSDM Jabar</span>
                </a>
                
                <div class="hidden lg:flex items-center space-x-8">
                    <a href="#" class="text-gray-600 dark:text-gray-200 hover:text-blue-700 dark:hover:text-blue-400 font-medium transition-colors duration-200 relative group animate-fade-in-up delay-3">Armada
                    ...
                    <a href="#" class="text-gray-600 dark:text-gray-200 hover:text-blue-700 dark:hover:text-blue-400 font-medium transition-colors duration-200 relative group animate-fade-in-up delay-4">Prosedur
                        <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-700 dark:bg-blue-400 transition-all duration-300 group-hover:w-full"></span>
                    </a>
                    <a href="#" class="text-gray-600 dark:text-gray-200 hover:text-blue-700 dark:hover:text-blue-400 font-medium transition-colors duration-200 relative group animate-fade-in-up delay-5">FAQ
                        <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-700 dark:bg-blue-400 transition-all duration-300 group-hover:w-full"></span>
                    </a>
                </div>
                
                <div class="flex items-center space-x-4">
                    <a href="/login" class="hidden sm:block px-6 py-3 bg-blue-700 text-white text-base font-semibold rounded-full shadow-lg hover:bg-blue-800 hover:scale-105 transition-all transform duration-300 btn-3d-push animate-fade-in-up delay-5">Login</a>
                    
                    <button @click="isDarkMode = !isDarkMode" class="p-2.5 rounded-full text-gray-600 dark:text-gray-300 bg-gray-200/50 dark:bg-gray-800/50 hover:bg-gray-300/50 dark:hover:bg-gray-700/50 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50 animate-fade-in-up delay-6">
                    ...
                    <button @click="isMenuOpen = !isMenuOpen" class="lg:hidden p-2.5 rounded-md text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-300 animate-fade-in-up delay-7">
            ...
            <div x-show="isMenuOpen" @click.away="isMenuOpen = false" x-transition.opacity.duration.300 class="lg:hidden py-4 space-y-2 text-center bg-white/90 dark:bg-gray-900/95 backdrop-blur-md rounded-lg shadow-xl mt-2">
                <a href="#" class="block py-2 text-gray-700 dark:text-gray-100 hover:text-blue-700 font-medium transition-colors">Armada</a>
                <a href="#" class="block py-2 text-gray-700 dark:text-gray-100 hover:text-blue-700 font-medium transition-colors">Prosedur</a>
                <a href="#" class="block py-2 text-gray-700 dark:text-gray-100 hover:text-blue-700 font-medium transition-colors">FAQ</a>
    ...
    <main>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="text-center lg:text-left">
                    ...
                    <p class="animate-fade-in-up delay-3 mt-6 text-xl text-gray-600 dark:text-gray-200 max-w-xl mx-auto lg:mx-0">
                        Akses armada kendaraan dinas premium dengan proses pengajuan yang **cerdas, efisien, dan terintegrasi penuh secara digital.**
                    </p>
                ...
                <div class="animate-fade-in-up delay-4 hidden lg:block relative group transform hover:scale-105 transition-transform duration-500">
                    <div class="relative p-10 bg-white/20 dark:bg-gray-900/40 rounded-3xl glassmorphism dark:glassmorphism-dark shadow-custom-light dark:shadow-custom-dark overflow-hidden hero-image-overlay">
                        <div class="aspect-w-16 aspect-h-9">
                            <img src="upload/bmw.png" alt="Ilustrasi Kendaraan Premium" class="w-full h-full object-cover rounded-xl transition-transform duration-500 group-hover:scale-105">
                        </div>
                        <div class="absolute bottom-6 right-6 p-3 bg-white/80 dark:bg-gray-800/80 rounded-full backdrop-blur-md text-xs font-semibold text-gray-700 dark:text-gray-200 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            Armada Eksklusif BPSDM
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="features" class="container mx-auto px-6 py-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                <div class="animate-fade-in-up delay-1 p-8 bg-white/50 dark:bg-gray-900/50 rounded-2xl shadow-custom-light dark:shadow-custom-dark backdrop-blur-sm transform hover:scale-105 transition-transform duration-300 feature-card">
                ...
                <div class="animate-fade-in-up delay-2 p-8 bg-white/50 dark:bg-gray-900/50 rounded-2xl shadow-custom-light dark:shadow-custom-dark backdrop-blur-sm transform hover:scale-105 transition-transform duration-300 feature-card">
                ...
                <div class="animate-fade-in-up delay-3 p-8 bg-white/50 dark:bg-gray-900/50 rounded-2xl shadow-custom-light dark:shadow-custom-dark backdrop-blur-sm transform hover:scale-105 transition-transform duration-300 feature-card">
                    <h3 class="text-6xl font-extrabold text-blue-700 dark:text-blue-400">98<span class="text-4xl">%</span></h3>
                    <p class="mt-4 text-xl font-semibold text-gray-700 dark:text-gray-100">Tingkat Kepuasan Tinggi</p>
