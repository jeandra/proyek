...
<body class="animated-gradient min-h-screen flex items-center justify-center p-4 text-gray-900 dark:text-gray-100 transition-all duration-500">
    ...
    <div class="relative w-full max-w-md p-8 sm:p-10 bg-white/70 dark:bg-gray-900/70 rounded-3xl shadow-custom-light dark:shadow-custom-dark backdrop-blur-xl animate-fade-in-up">
        ...
        <div class="absolute top-4 right-4">
            <button @click="isDarkMode = !isDarkMode" class="p-2.5 rounded-full text-gray-600 dark:text-gray-300 bg-gray-200/50 dark:bg-gray-800/50 hover:bg-gray-300/50 dark:hover:bg-gray-700/50 transition duration-300 focus:outline-none">
                <svg x-show="!isDarkMode" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="text-center">
            <svg class="mx-auto h-12 w-12 text-blue-700 dark:text-blue-400 animate-fade-in-up delay-1" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14.59L6.41 12 5 13.41 11 19.41l8-8L17.59 10 11 16.59z"/>
            </svg>
        ...
        <form action="<?= site_url('login') ?>" method="post" class="space-y-6 mt-6">
            ...
            <div class="relative animate-fade-in-up delay-3">
                ...
                <input type="email" name="email" required placeholder="Email" class="w-full pl-10 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white/50 dark:bg-gray-800/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
            </div>
